...
In this part you will need to uncomment the correct portion of the commented code in order to complete 10 Java and Object-oriented programming questions. Read the instructions in the JavaDoc carefully for each task to understand the wanted behaviour. Feel free to run the code in order to understand and verify the behaviour of the code, which you can do by creating main methods and adding some code to execute in the various Task classes. For task 1 and 2 you can also run the unit tests to see if you have the correct answer.
...
* [Part1Tests](../../../../../../test/java/com/shopstore/retail/part1/Part1Test.java)
