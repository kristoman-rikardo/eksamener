# TDT4100 Java Exam spring 2025 - Exam 2 (1500)
...
* [Part 1](src/main/java/com/twowheels/assembly/part1/README_en.md) (20%)
* [Part 2](src/main/java/com/twowheels/assembly/part1/README_en.md) (20%)

## PART 3-6 (60%)

TwoWheels is a company specializing in custom bike builds for private customers.

A custom bike is a bicycle that has been built or modified to meet a rider's specific preferences, needs, or style. Unlike mass-produced bikes, custom bikes are often tailored in terms of frame geometry, materials, components, and aesthetics.

TwoWheels is developing new software used in the assembly process of custom bikes. The software is written in the Java language. Your assignment is to contribute by developing some of the code.
...
* [Part 6](src/main/java/com/bytebadger/assembly/part2/README_en.md) (15%) - In this task you should implement a methods using the observer/observable-pattern.

## Important notes

1. The code for all parts is located in [src/main/java/com/twoweheels/assembly](src/main/java/com/twoweheels/assembly/)

2. DO NOT MODIFY CODE in [src/main/java/no/ntnu/tdt4100/](src/main/java/no/ntnu/tdt4100/)

3. There are _some_ unit tests provided. Passing tests indicate that your implementation is correct. The tests are located in the [test/java/com/twoweheels/assembly](./src/test/java/com/twoweheels/assembly/) folder.
...
i.e., when JavaDoc specifies that the class should be called `BikePart`, it should not be called `bikePart`, `bikepart` or `BIKEPART`.
...
After you have downloaded the zip file, unzip it. This gives a folder named **ord2025-1500**.

### For Visual Studio Code

Then go into VSCode, and go to File -> Open Folder. A file navigation window opens. Find the folder you unzipped (**ord2025-1500**), and select it.
