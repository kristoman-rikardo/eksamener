# TDT4100 Javaeksamen vår 2025 - eksamen 2 (1500)
...
* [Del 1](src/main/java/com/twowheels/assembly/part1/README_nn.md) (20%)
* [Del 2](src/main/java/com/twowheels/assembly/part2/README_nn.md) (20%)

## DEL 3-6 (60%)

TwoWheels er eit selskap som spesialiserer seg på skreddarsydde syklar for privatkundar.

Ein skreddarsydd sykkel er ein sykkel som er bygd eller modifisert for å oppfylle ein rittar sine spesifikke preferansar, behov eller stil. I motsetnad til masseproduserte syklar, er skreddarsydde syklar ofte tilpassa når det gjeld rammegeometri, materiale, komponentar og estetikk.

TwoWheels utviklar ny programvare som blir brukt i monteringsprosessen for skreddarsydde syklar. Programvara er skriven i Java. Di oppgåve er å bidra ved å utvikle delar av koden.

Oppgåvene dine er organiserte som følgjer:

* [Del 3](src/main/java/com/twowheels/assembly/part3/README_nn.md) (15%) - I denne oppgåva skal du implementere klassar basert på grensesnitt.
* [Del 4](src/main/java/com/twowheels/assembly/part4/README_nn.md) (15%) - I denne oppgåva skal du implementere metodar for å jobbe med ein hierarkisk struktur.
* [Del 5](src/main/java/com/twowheels/assembly/part5/README_nn.md) (15%) - I denne delen skal du implementere metodar for å lese og skrive filer.
* [Del 6](src/main/java/com/twowheels/assembly/part2/README_nn.md) (15%) - I denne delen skal du implementere metodar som bruker observatør/observert-mønsteret.

## Viktige merknader

1. Koden for alle delane ligg i [src/main/java/com/twowheels/assembly](src/main/java/com/twowheels/assembly/)

2. IKKJE MODIFISER KODEN i [src/main/java/no/ntnu/tdt4100/](src/main/java/no/ntnu/tdt4100/).

3. Det er _nokre_ testar tilgjengelege. Dersom desse testane er grønne, indikerer det at implementeringa di er korrekt. Testane er tilgjengelege i mappa [test/java/com/twowheels/assembly](./src/test/java/com/twowheels/assembly/).
...
Etter at du har lasta ned zip-fil, så unzip denne. Dette gir ei mappe som heiter **ord2025-1500**.

### For Visual Studio Code

Gå så inn i VSCode, og gå til File -> Open Folder. Eit filnavigeringsvindauge opnast. Finn fram til mappa du unzippa (**ord2025-1500**), og vel denne. VSCode vil då, pga. POM-fila som ligg i mappa, automatisk finne ut at dette er eit Maven Java-prosjekt. (Under føresetnad at Java-utvidinga er installert i VSCode.)
