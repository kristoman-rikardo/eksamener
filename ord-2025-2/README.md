...
* [Del 1](src/main/java/com/twowheels/assembly/part1/README.md) (20%)
* [Del 2](src/main/java/com/twowheels/assembly/part2/README.md) (20%)

## DEL 3-6 (60%)

TwoWheels er et selskap som spesialiserer seg på skreddersydde sykler for privatkunder.

En skreddersydd sykkel er en sykkel som er bygget eller modifisert for å oppfylle en rytterens spesifikke preferanser, behov eller stil. I motsetning til masseproduserte sykler, er skreddersydde sykler ofte tilpasset når det gjelder rammegeometri, materialer, komponenter og estetikk.

TwoWheels utvikler ny programvare som brukes i monteringsprosessen for skreddersydde sykler. Programvaren er skrevet i Java. Din oppgave er å bidra ved å utvikle deler av koden.
...
* [Del 3](src/main/java/com/twowheels/assembly/part3/README.md) (15%) - I denne oppgaven skal du implementere klasser basert på grensesnitt.
* [Del 4](src/main/java/com/twowheels/assembly/part4/README.md) (15%) - I denne oppgaven skal du implementere metoder for å jobbe med en hierarkisk struktur.
* [Del 5](src/main/java/com/twowheels/assembly/part5/README.md) (15%) - I denne delen skal du implementere metoder for å lese og skrive filer.
* [Del 6](src/main/java/com/twowheels/assembly/part2/README.md) (15%) - I denne delen skal du implementere metoder for som bruker observatør/observert-mønsteret.

## Viktige merknader

1. Koden for alle delene ligger i [src/main/java/com/twowheels/assembly](src/main/java/com/twowheels/assembly/)

2. IKKE MODIFISER KODEN i [src/main/java/no/ntnu/tdt4100/](src/main/java/no/ntnu/tdt4100/).

3. Det er _noen_ tester tilgjengelige. Dersom disse testene er grønne, indikerer det at implementeringen din er korrekt. Testene er tilgjengelig i mappen [test/java/com/twowheels/assembly](./src/test/java/com/twowheels/assembly/).
...
dvs. når JavaDoc spesifiserer at klassen skal hete `BikeComponent`, skal den ikke hete `bikeComponent`, `bikecomponent` eller `BIKECOMPONENT`.
...
Etter at du har lastet ned zip-fil, så unzip denne. Dette gir en mappe som heter **ord2025-1500**.

### For Visual Studio Code

Gå så inn i VSCode, og gå til File -> Open Folder. Et filnavigeringsvindu åpnes. Finn frem til mappen du unzippet (**ord2025-1500**), og velg denne. VSCode vil da, pga. POM-filen som ligger i mappen, automatisk finne ut at dette er et Maven Java-prosjekt. (Under forutsetning at Java-utvidelsen er installert i VSCode.)
